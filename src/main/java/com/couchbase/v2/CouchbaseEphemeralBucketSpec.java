...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"compressionMode","conflictResolution","enableFlush","evictionPolicy","ioPriority","maxTTL","memoryQuota","minimumDurability","name","replicas","scopes"})
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(using = com.fasterxml.jackson.databind.JsonDeserializer.None.class)
@javax.annotation.processing.Generated("io.fabric8.java.generator.CRGeneratorRunner")
public class CouchbaseEphemeralBucketSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    public enum EvictionPolicy {
        ...
        NOEVICTION("noEviction"), @com.fasterxml.jackson.annotation.JsonProperty("nruEviction")
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("EvictionPolicy controls how Couchbase handles memory exhaustion.  No eviction means that Couchbase server will make this bucket read-only when memory is exhausted in order to avoid data loss.  NRU eviction will delete documents that haven't been used recently in order to free up memory. This field must be \"noEviction\" or \"nruEviction\", defaulting to \"noEviction\".")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private EvictionPolicy evictionPolicy = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("\"noEviction\"", EvictionPolicy.class);
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("MemoryQuota is a memory limit to the size of a bucket.  When this limit is exceeded, documents will be evicted from memory defined by the eviction policy.  The memory quota is defined per Couchbase pod running the data service.  This field defaults to, and must be greater than or equal to 100Mi.  More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#resource-units-in-kubernetes")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseephemeralbucketspec.Scopes scopes;

    public com.couchbase.v2.couchbaseephemeralbucketspec.Scopes getScopes() {
        return scopes;
    }

    public void setScopes(com.couchbase.v2.couchbaseephemeralbucketspec.Scopes scopes) {
        this.scopes = scopes;
    }
}
