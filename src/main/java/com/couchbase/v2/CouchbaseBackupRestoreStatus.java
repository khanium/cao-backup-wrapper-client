...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"archive","backups","duration","failed","job","lastFailure","lastRun","lastSuccess","output","pod","repo","running"})
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(using = com.fasterxml.jackson.databind.JsonDeserializer.None.class)
@javax.annotation.processing.Generated("io.fabric8.java.generator.CRGeneratorRunner")
public class CouchbaseBackupRestoreStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<com.couchbase.v2.couchbasebackuprestorestatus.Backups> backups;

    public java.util.List<com.couchbase.v2.couchbasebackuprestorestatus.Backups> getBackups() {
        return backups;
    }

    public void setBackups(java.util.List<com.couchbase.v2.couchbasebackuprestorestatus.Backups> backups) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Duration tells us how long the last restore took.  More info: https://golang.org/pkg/time/#ParseDuration")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Failed indicates whether the most recent restore has failed.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("LastFailure tells us the time the last failed restore failed.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("LastRun tells us the time the last restore job started.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("LastSuccess gives us the time the last successful restore finished.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("DEPRECATED - field may no longer be populated. Output reports useful information from the backup process.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    @io.fabric8.generator.annotation.Required()
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Running indicates whether a restore is currently being performed.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
