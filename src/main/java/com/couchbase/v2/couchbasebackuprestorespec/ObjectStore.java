...
public class ObjectStore implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private com.couchbase.v2.couchbasebackuprestorespec.objectstore.Endpoint endpoint;

    public com.couchbase.v2.couchbasebackuprestorespec.objectstore.Endpoint getEndpoint() {
        return endpoint;
    }

    public void setEndpoint(com.couchbase.v2.couchbasebackuprestorespec.objectstore.Endpoint endpoint) {
