package com.couchbase.v2.couchbaseclusterspec.volumeclaimtemplates;

@com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"accessModes","dataSourceRef","resources","selector","storageClassName","volumeMode","volumeName"})
...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.volumeclaimtemplates.spec.DataSourceRef dataSourceRef;

    public com.couchbase.v2.couchbaseclusterspec.volumeclaimtemplates.spec.DataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(com.couchbase.v2.couchbaseclusterspec.volumeclaimtemplates.spec.DataSourceRef dataSourceRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.volumeclaimtemplates.spec.Resources resources;

    public com.couchbase.v2.couchbaseclusterspec.volumeclaimtemplates.spec.Resources getResources() {
        return resources;
    }

    public void setResources(com.couchbase.v2.couchbaseclusterspec.volumeclaimtemplates.spec.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.volumeclaimtemplates.spec.Selector selector;

    public com.couchbase.v2.couchbaseclusterspec.volumeclaimtemplates.spec.Selector getSelector() {
        return selector;
    }

    public void setSelector(com.couchbase.v2.couchbaseclusterspec.volumeclaimtemplates.spec.Selector selector) {
