...
public class SecurityContext implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.security.securitycontext.Capabilities capabilities;

    public com.couchbase.v2.couchbaseclusterspec.security.securitycontext.Capabilities getCapabilities() {
        return capabilities;
    }

    public void setCapabilities(com.couchbase.v2.couchbaseclusterspec.security.securitycontext.Capabilities capabilities) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.security.securitycontext.SeLinuxOptions seLinuxOptions;

    public com.couchbase.v2.couchbaseclusterspec.security.securitycontext.SeLinuxOptions getSeLinuxOptions() {
        return seLinuxOptions;
    }

    public void setSeLinuxOptions(com.couchbase.v2.couchbaseclusterspec.security.securitycontext.SeLinuxOptions seLinuxOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.security.securitycontext.SeccompProfile seccompProfile;

    public com.couchbase.v2.couchbaseclusterspec.security.securitycontext.SeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(com.couchbase.v2.couchbaseclusterspec.security.securitycontext.SeccompProfile seccompProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.security.securitycontext.WindowsOptions windowsOptions;

    public com.couchbase.v2.couchbaseclusterspec.security.securitycontext.WindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(com.couchbase.v2.couchbaseclusterspec.security.securitycontext.WindowsOptions windowsOptions) {
