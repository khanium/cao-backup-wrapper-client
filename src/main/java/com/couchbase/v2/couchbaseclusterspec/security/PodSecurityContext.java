...
public class PodSecurityContext implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.SeLinuxOptions seLinuxOptions;

    public com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.SeLinuxOptions getSeLinuxOptions() {
        return seLinuxOptions;
    }

    public void setSeLinuxOptions(com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.SeLinuxOptions seLinuxOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.SeccompProfile seccompProfile;

    public com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.SeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.SeccompProfile seccompProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.Sysctls> sysctls;

    public java.util.List<com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.Sysctls> getSysctls() {
        return sysctls;
    }

    public void setSysctls(java.util.List<com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.Sysctls> sysctls) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.WindowsOptions windowsOptions;

    public com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.WindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(com.couchbase.v2.couchbaseclusterspec.security.podsecuritycontext.WindowsOptions windowsOptions) {
