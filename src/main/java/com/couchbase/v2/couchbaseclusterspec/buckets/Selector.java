package com.couchbase.v2.couchbaseclusterspec.buckets;
...
public class Selector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<com.couchbase.v2.couchbaseclusterspec.buckets.selector.MatchExpressions> matchExpressions;

    public java.util.List<com.couchbase.v2.couchbaseclusterspec.buckets.selector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<com.couchbase.v2.couchbaseclusterspec.buckets.selector.MatchExpressions> matchExpressions) {
