...
public class Env implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.servers.env.ValueFrom valueFrom;

    public com.couchbase.v2.couchbaseclusterspec.servers.env.ValueFrom getValueFrom() {
        return valueFrom;
    }

    public void setValueFrom(com.couchbase.v2.couchbaseclusterspec.servers.env.ValueFrom valueFrom) {
