package com.couchbase.v2.couchbaseclusterspec.servers.pod.spec.topologyspreadconstraints;
...
public class LabelSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<com.couchbase.v2.couchbaseclusterspec.servers.pod.spec.topologyspreadconstraints.labelselector.MatchExpressions> matchExpressions;

    public java.util.List<com.couchbase.v2.couchbaseclusterspec.servers.pod.spec.topologyspreadconstraints.labelselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<com.couchbase.v2.couchbaseclusterspec.servers.pod.spec.topologyspreadconstraints.labelselector.MatchExpressions> matchExpressions) {
