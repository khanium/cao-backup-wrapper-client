...
public class SecurityContext implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.securitycontext.SeLinuxOptions seLinuxOptions;

    public com.couchbase.v2.couchbaseclusterspec.securitycontext.SeLinuxOptions getSeLinuxOptions() {
        return seLinuxOptions;
    }

    public void setSeLinuxOptions(com.couchbase.v2.couchbaseclusterspec.securitycontext.SeLinuxOptions seLinuxOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.securitycontext.SeccompProfile seccompProfile;

    public com.couchbase.v2.couchbaseclusterspec.securitycontext.SeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(com.couchbase.v2.couchbaseclusterspec.securitycontext.SeccompProfile seccompProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<com.couchbase.v2.couchbaseclusterspec.securitycontext.Sysctls> sysctls;

    public java.util.List<com.couchbase.v2.couchbaseclusterspec.securitycontext.Sysctls> getSysctls() {
        return sysctls;
    }

    public void setSysctls(java.util.List<com.couchbase.v2.couchbaseclusterspec.securitycontext.Sysctls> sysctls) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbaseclusterspec.securitycontext.WindowsOptions windowsOptions;

    public com.couchbase.v2.couchbaseclusterspec.securitycontext.WindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(com.couchbase.v2.couchbaseclusterspec.securitycontext.WindowsOptions windowsOptions) {
