package com.couchbase.v2.couchbaseclusterspec.logging.audit.garbagecollection.sidecar;
...
public class Resources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<com.couchbase.v2.couchbaseclusterspec.logging.audit.garbagecollection.sidecar.resources.Claims> claims;

    public java.util.List<com.couchbase.v2.couchbaseclusterspec.logging.audit.garbagecollection.sidecar.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(java.util.List<com.couchbase.v2.couchbaseclusterspec.logging.audit.garbagecollection.sidecar.resources.Claims> claims) {
        this.claims = claims;
    }
