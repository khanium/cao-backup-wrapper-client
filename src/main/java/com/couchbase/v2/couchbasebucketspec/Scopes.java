package com.couchbase.v2.couchbasebucketspec;
...
public class Scopes implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<com.couchbase.v2.couchbasebucketspec.scopes.Resources> resources;

    public java.util.List<com.couchbase.v2.couchbasebucketspec.scopes.Resources> getResources() {
        return resources;
    }

    public void setResources(java.util.List<com.couchbase.v2.couchbasebucketspec.scopes.Resources> resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.couchbase.v2.couchbasebucketspec.scopes.Selector selector;

    public com.couchbase.v2.couchbasebucketspec.scopes.Selector getSelector() {
        return selector;
    }

    public void setSelector(com.couchbase.v2.couchbasebucketspec.scopes.Selector selector) {
